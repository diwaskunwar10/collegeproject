...
<body>
  ...
  $sql3="SELECT org FROM students where registration=$id ";
  $data1=mysqli_query($conn,$sql3);
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card bdr" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php 
                                        $sql2="select name from admin where email='$org'";
                                        $qfire=mysqli_query($conn,$sql2);
                                        $result=mysqli_fetch_array($qfire);
                                        echo $result['name'];
