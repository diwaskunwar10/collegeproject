...
<form action="" method="post" enctype="" class="form-group ms-3">
            <div class="row">
                <div class="col-sm-4 ">
                    <label for="name" class="form-label">Full Name:</label>
                    <input class="form-control" placeholder="Full Name" type="text" name="sname" id="sname" required
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="reg_num" placeholder="Registration Number" required
                        name="reg_num" value="<?php echo $result['registration']; ?>">
                </div>
                <div class="col-sm-4">
                    <label for="Phonenumber" class="form-label">Phone Number:</label>
                    <input type="tel" class="form-control" name="Phone" id=" Phonenumber" placeholder="Phone Number"
                        required value="<?php echo $result['phone']; ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 form-check p-1">
                    ...
                    <select class="form-select" name="course" value="<?php echo $result['course']; ?>">
                        ...
                        <option value="Bsc.CSIT" <?php if($result['course']=='Bsc.CSIT' ){ echo 'selected' ;}?>>Bsc.CSIT
                        </option>
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <input type="date" name="eyear" id="eyear " class="form-control" required
                        value="<?php echo $result['enrollyear']; ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 form-check p-1">
                    ...
                    <select class="form-select" name="gender" value="<?php echo $result['gender']; ?>">
                        ...
                        <option value="Female" <?php if($result['gender']=='Female' ){ echo 'selected' ;}?>>Female
                        </option>
